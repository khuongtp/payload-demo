          ...
          return (
            <div className="flex mx-40 my-20">
              <div className="flex-1">
                ...
                >
                  <p>
                    With a team of highly experienced designers, we have done it carefully and
                    simply. The components work together to create a beautiful landing. It is
                    essential template for designers
                  </p>
                </div>
                <button
